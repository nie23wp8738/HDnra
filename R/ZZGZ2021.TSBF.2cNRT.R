...
#' @usage ZZGZ2021.TSBF.2cNRT(y1, y2)
...
ZZGZ2021.TSBF.2cNRT <- function(y1, y2) {
  ...
  hname <- paste("Zhang et al. (2021)'s test", sep = "")
  ...
  out <- list(
    statistic = c("T[ZZGZ]" = round(stat,4)),
